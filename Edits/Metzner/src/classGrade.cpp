...
void classGrade::deleteClass()
{
    ...
    delete current; //You don't need to delete current here because it is pointing to NULL
...
//here is the added functionality that allows the user to pick what minimum percent they need on the final in order to achieve a
//user defined end grade (0-100%)
void classGrade::min2Percent()
{
    if(this->finalTaken == true)
    {
        cout<<"This operation calculates the minimum score the user needs to pass this class"<<endl;
    ...
    else
    {
        ...
        cout << endl;
        cout << "Please Enter The Minimum Percentage Grade You Would Like To Receive In"<< this->className << endl;
        ...
        cout<<"In Order To Achieve A " << percent <<"% In The Class..."<<endl;
        cout<<"You need a minimum score of "<<grade2pass<<" on the final in order to pass "<<this->className<<endl;
        if(grade2pass >= 85)
            cout<<"Good luck ~~"<<endl;
        else if (grade2pass < 0 || grade2pass > 100)
            cout << "Welp" << endl;
    }
